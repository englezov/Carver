// DEPRECATED_PROVENANCE_ONLY unless separately reauthorized.
// Legacy MES-only NinjaTrader Desktop daily export helper for Carver.
// Defaults to disarmed. Retained to document the first helper lineage; prefer
// CarverMesTinyDailyExporterSessionEndUtc for the corrected timestamp policy.
// Attach only to a 1 Day Last MES 06-26 chart under an explicit operator gate.
...
{
    public class CarverMesTinyDailyExporter : Indicator
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name = "CarverMesTinyDailyExporter";
                Description = "DEPRECATED provenance-only Carver MES 06-26 helper; prefer SessionEndUtc v2 unless separately reauthorized.";
